...
- [Tools](#tools)
  - [1. FolderBoy Cleaner](#1-folderboy-cleaner)
  - [2. Sonarr Folder Renamer](#2-sonarr-folder-renamer)
  - [3. Radarr Folder Renamer](#3-radarr-folder-renamer)
  - [4. Lidarr Folder Renamer](#4-lidarr-folder-renamer)
  - [5. Orphan Scanner](#5-orphan-scanner)
  - [6. Full Run](#6-full-run)
  - [7. Media Dashboard](#7-media-dashboard)
  - [8. Media File Renamer](#8-media-file-renamer)
- [Setup](#setup)
...
You also need `FolderBoy.config.ps1` configured with your settings before running FolderBoy — see [Setup](#setup) below.
...
Use **option 6 (Full Run)** for regular maintenance. See [Full Run](#6-full-run) above for the three run modes and what each one does.
...
| `tests\FolderBoy_LogicTests.ps1` | ✅ Yes | Standalone logic test suite |
| `tests\FolderBoy_Test_Checklist.md` | ✅ Yes | Interactive test checklist |
| `tests\Run-Tests.bat` | ✅ Yes | One-click test runner |
...
See [Setup step 4](#4-run-folderboy) above.
